...
import { Calendar, MapPin, FileText, ArrowRight, Hexagon, Sparkles, Building2 } from 'lucide-react';
...
const StatusBadge = ({ icon: Icon, label, value, delay }) => (
  ...
  >
    ...
    <div className="flex flex-col">
      <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400 font-mono">{label}</span>
      <span className="text-sm font-semibold text-slate-800 font-tech">{value}</span>
    </div>
  </motion.div>
);
      ...
      <div className="absolute inset-0 z-0 opacity-40 pointer-events-none">
        ...
        <div className="grid grid-cols-12 gap-4 h-full transform -skew-x-12 scale-110 translate-x-20">
          <div className="col-span-3 space-y-4 pt-20">
            <div className="h-64 rounded-2xl bg-cover bg-center shadow-2xl grayscale opacity-50" style={{ backgroundImage: 'url("/uploads/1.jpg")' }}></div>
            <div className="h-80 rounded-2xl bg-cover bg-center shadow-2xl grayscale opacity-50" style={{ backgroundImage: 'url("/uploads/2.jpeg")' }}></div>
          </div>
          <div className="col-span-4 space-y-4 -mt-10">
            <div className="h-48 rounded-2xl bg-cover bg-center shadow-2xl grayscale opacity-50" style={{ backgroundImage: 'url("/uploads/1.jpg")' }}></div>
            <div className="h-72 rounded-2xl bg-cover bg-center shadow-2xl grayscale opacity-50" style={{ backgroundImage: 'url("/uploads/3.jpg")' }}></div>
          </div>
          <div className="col-span-3 space-y-4 pt-32">
            <div className="h-56 rounded-2xl bg-cover bg-center shadow-2xl grayscale opacity-50" style={{ backgroundImage: 'url("/uploads/3.jpg")' }}></div>
            <div className="h-64 rounded-2xl bg-cover bg-center shadow-2xl grayscale opacity-50" style={{ backgroundImage: 'url("/uploads/2.jpeg")' }}></div>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid lg:grid-cols-12 gap-16 items-center">
        ...
        <div className="lg:col-span-7">
          ...
          >
            ...
            <h1 className="font-tech text-6xl md:text-8xl font-bold text-slate-900 leading-[0.9] tracking-tighter mb-6">
              Chemical <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-ind-600 to-ind-800">Constellation</span>
            </h1>

            <div className="h-1 w-24 bg-ind-600 mb-8"></div>

            <p className="text-xl text-slate-600 mb-10 max-w-lg leading-relaxed font-light">
              Engineering the molecular future. Next-generation materials for <span className="font-semibold text-slate-900 border-b-2 border-ind-200">Energy & Environment.</span>
            </p>

            <div className="grid sm:grid-cols-2 gap-4 mb-10 max-w-md">
              <StatusBadge icon={Calendar} label="Timeline" value="Apr 03-04, 2026" delay={0.2} />
              <StatusBadge icon={FileText} label="Publication" value="Materials Today" delay={0.4} />
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              <button className="group relative px-8 py-4 bg-slate-900 text-white rounded-xl font-tech font-bold overflow-hidden shadow-xl shadow-slate-900/20 transition-all hover:scale-105 hover:shadow-2xl">
                ...
                <div className="relative flex items-center gap-2">
                  Submit Abstract <ArrowRight size={18} />
                </div>
              </button>
              ...
              <div className="relative h-full w-full glass-panel rounded-[2rem] p-3 border-2 border-white/60 shadow-2xl shadow-slate-900/10 flex flex-col gap-3">
                 ...
                 <div className="relative flex-1 rounded-[1.5rem] overflow-hidden border border-white/50 shadow-inner group">
                    ...
                    <div className="absolute top-4 right-4 bg-white/20 backdrop-blur-md border border-white/40 px-3 py-1.5 rounded-lg flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-bold text-white uppercase tracking-wider">Live Cam</span>
                    </div>
                    ...
                    <div className="absolute bottom-6 left-6 text-white">
                        <div className="flex items-center gap-2 mb-1 opacity-80">
                            <MapPin size={14} />
                            <span className="text-xs font-mono font-bold uppercase tracking-widest">Venue_01</span>
                        </div>
                        <h3 className="font-serif text-2xl font-bold leading-tight">National Institute of<br/>Technology Jalandhar</h3>
                    </div>
                 </div>
                 ...
                 <div className="h-24 bg-white/50 rounded-[1.5rem] border border-white/50 p-4 flex items-center justify-between backdrop-blur-sm">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-0.5">Location</p>
                            <p className="text-sm font-bold text-slate-800 font-tech">Punjab, India</p>
                        </div>
                    </div>
                    ...
                    <div className="text-right">
                         <div className="flex items-center justify-end gap-1 text-slate-400 mb-0.5">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-widest">Edition</span>
                         </div>
                         <p className="text-xl font-bold text-slate-900 font-tech">2026</p>
                    </div>
