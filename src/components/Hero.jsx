      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-100 pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 w-full grid md:grid-cols-12 gap-10 md:gap-16 items-center">
          ...
          <div className="md:col-span-7">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1 mb-6 md:mb-8 border border-ind-200 bg-ind-50/50 backdrop-blur-md rounded-full text-ind-800 text-[10px] font-mono font-bold uppercase tracking-widest shadow-sm">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold font-tech text-ind-700 tracking-tight mb-4 md:mb-6">
                Cheminar 2026
              </h2>

              <div className="h-1 w-20 md:w-24 bg-ind-600 mb-6 md:mb-8"></div>
              ...
              <div className="flex flex-col sm:flex-row sm:flex-wrap gap-4">
                <button className="group relative px-8 py-4 bg-slate-900 text-white rounded-xl font-tech font-bold overflow-hidden shadow-xl shadow-slate-900/20 transition-all hover:scale-105 hover:shadow-2xl">
                  ...
                  <div className="relative flex items-center gap-2">
                    <a href="#submission" className="flex items-center gap-2">
